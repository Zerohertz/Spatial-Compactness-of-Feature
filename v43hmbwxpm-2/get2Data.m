...
for i = ['A', 'B', 'C', 'D']
    for j = ['1', '2', '3']
        cd 'D:\Spatial-Compactness-of-Feature\v43hmbwxpm-2\2 Data collected from a bearing with inner race fault'
        dat = append('I-', i, '-', j, '.mat');
        tmp = load(dat);
        cd 'D:\Spatial-Compactness-of-Feature\'
        Fault1(Num).tab = makeLearningData(tmp.Channel_1, 1000, "Fault");
        Num = Num + 1;
    end
end
